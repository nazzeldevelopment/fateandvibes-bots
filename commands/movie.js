...
export default async function movieCommand(ctx, args) {
    ...
    // Extract the movie title and type
    ...
    if (!['movie', 'series', 'episode'].includes(type)) {
        type = 'movie'; // Treat as a movie if the last argument is not a valid type
    }
    ...
    try {
        ...
        console.log('Movie API Response:', movie); // Debugging line to see the full response
        ...
        // Fetch availability on streaming platforms
